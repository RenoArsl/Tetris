...
int main() {
    ...
    delay = 102.375;//819/800*1000
    t.loadFromFile("images/123456.png");
    t1.loadFromFile("images/NXXr56dh.png");
    t2.loadFromFile("images/107758580_310857190070231_5112728586985535061_n.png");
    Sprite gameover(t2);
    Sprite bg(t1);
    Sprite s(t);
